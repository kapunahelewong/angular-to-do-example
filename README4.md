...
This section walks you through creating a component to handle the list of items.
...
Add mark up for managing items by replacing the placeholder content in `item.component.html` with the following:
